    ...
    \ForAll{$\sigma^2_u \in \{\textrm{list of observation variance}\}$}{
        \ForAll{$\sigma^2_\epsilon \in \{\textrm{list of residual variance}\}$}{
            ...
            \For{10000 iterations}{
                ...
                Calculate $\hat{\beta}_{OLS}$, $\hat{\beta}_{MME}$, $\hat{\sigma^2_\epsilon}_{OLS}$, $\hat{\sigma^2_\epsilon}_{MME}$ from the observations $\tilde{x}$, $y$, and prior information on observation error $\sigma^2_u$\;
