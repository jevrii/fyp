...
We present empirical results from simulations based on normal, Student's $t$ and $\chi^2$ distributions on the ordinary least squares and method of moments estimation of regression parameters $\beta$ and $\sigma^2_\epsilon$.
...
We can further obtain the limit of the OLS estimated variance, as we assumed earlier that $\epsilon$, $x$ and $u$ are uncorrelated:
